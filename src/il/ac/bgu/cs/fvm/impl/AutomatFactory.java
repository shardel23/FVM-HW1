...
public class AutomatFactory<P> {

    Set<Set<P>> all;

    AutomatFactory(TransitionSystem<?,?,P> ts) {
    ...
    Automaton<String, P> eventuallyPhi1AndThenAlwaysPhi2Aut(Predicate<Set<P>> phi1, Predicate<Set<P>> phi2) {
    ...
    Automaton<String, P> eventuallyPhiAut(Predicate<Set<P>> phi) {
        Automaton<String, P> aut = new Automaton<>();
